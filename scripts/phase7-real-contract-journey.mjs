...
import { acquirePidLock, loadRun } from "./phase7-runner-lib.mjs";
...
let release;
try { release = acquirePidLock(path.join(runDirectory, `journey-${index}.lock`), `Phase 7 journey ${index} lock`); }
