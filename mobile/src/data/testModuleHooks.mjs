...
export async function resolve(specifier, context, nextResolve) {
    ...
    if (specifier === "@/lib/supabase") return coordinatorTestStub("export const getFirebaseAccessToken=async()=> 'fixture-token'; export const supabaseEnabled=true; export const supabase=null;");
