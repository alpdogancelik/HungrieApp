    ...
    plugins: [
        plugin(({ addComponents, addUtilities }) => {
            ...
            addComponents({
                ...
                ".cart-item": {
                    "@apply flex flex-row items-start justify-between mb-4 bg-white dark:bg-[#171A20] rounded-3xl p-4 shadow-lg shadow-black/5 border border-gray-100 dark:border-[#2A2E35]": {},
                },
                ".cart-item__image": {
                    "@apply size-20 bg-primary/10 rounded-2xl flex items-center justify-center": {},
                },
                ".cart-item__actions": {
                    "@apply flex flex-row items-center justify-center size-6 rounded-full bg-gray-50 dark:bg-[#22262E] border border-gray-100 dark:border-[#2A2E35]": {},
                },
                ...
                ".filter": { "@apply px-5 py-2 rounded-full mr-2 bg-white dark:bg-[#171A20] border border-gray-100 dark:border-[#2A2E35] shadow-sm shadow-black/5": {} },
                ".menu-card": { "@apply relative flex-1 rounded-3xl bg-white dark:bg-[#171A20] p-5 shadow-lg shadow-black/5 border border-gray-50 dark:border-[#2A2E35]": {} },
                ".profile-field": {
                    "@apply flex flex-row items-center justify-between mb-4 rounded-2xl bg-white dark:bg-[#171A20] px-4 py-3 border border-gray-100 dark:border-[#2A2E35]": {},
                },
                ".profile-field__icon": {
                    "@apply size-12 rounded-2xl bg-primary/10 flex items-center justify-center mr-3": {},
                },
                ".searchbar": {
                    "@apply relative flex flex-row items-center justify-start w-full bg-white dark:bg-[#171A20] shadow-lg shadow-black/5 rounded-full font-ezra-medium text-dark-100 dark:text-slate-50 gap-4 px-5": {},
                },
                ...
                ".restaurant-card": { "@apply flex flex-row gap-4 bg-white dark:bg-[#171A20] p-4 rounded-3xl border border-gray-100 dark:border-[#2A2E35] shadow-lg shadow-black/5": {} },
                ".rating-pill": { "@apply flex flex-row items-center rounded-full bg-white/90 dark:bg-[#1C2027] px-3 py-1 border border-gray-100 dark:border-[#2A2E35]": {} },
                ".info-chip": { "@apply flex flex-row items-center gap-1 px-3 py-1 rounded-full bg-gray-50 dark:bg-[#22262E] border border-gray-100 dark:border-[#2A2E35]": {} },
                ...
                ".chip": { "@apply px-4 py-2 rounded-full bg-white dark:bg-[#171A20] border border-gray-100 dark:border-[#2A2E35] flex-row items-center gap-2": {} },
                ".section-title": { "@apply text-lg font-ezra-bold text-dark-100 dark:text-slate-50": {} },
                ".secondary-card": { "@apply rounded-3xl p-4 bg-white dark:bg-[#171A20] shadow-lg shadow-black/5 border border-gray-100 dark:border-[#2A2E35]": {} },
            });
        }),
    ],
};
