    ...
    plugins: [
        plugin(({ addComponents, addUtilities }) => {
            ...
            addComponents({
                ...
                ".cart-item": {
                    "@apply flex flex-row items-start justify-between mb-4 bg-white dark:bg-[#0D1B2D] rounded-3xl p-4 shadow-lg shadow-black/5 border border-gray-100 dark:border-[#29405C]": {},
                },
                ".cart-item__image": {
                    "@apply size-20 bg-primary/10 rounded-2xl flex items-center justify-center": {},
                },
                ".cart-item__actions": {
                    "@apply flex flex-row items-center justify-center size-6 rounded-full bg-gray-50 dark:bg-[#172A42] border border-gray-100 dark:border-[#29405C]": {},
                },
                ...
                ".input": { "@apply rounded-lg p-3 w-full text-base font-ezra-semibold text-dark-100 dark:text-slate-50 border-b leading-5": {} },
                ".filter": { "@apply px-5 py-2 rounded-full mr-2 bg-white dark:bg-[#0D1B2D] border border-gray-100 dark:border-[#29405C] shadow-sm shadow-black/5": {} },
                ".menu-card": { "@apply relative flex-1 rounded-3xl bg-white dark:bg-[#0D1B2D] p-5 shadow-lg shadow-black/5 border border-gray-50 dark:border-[#29405C]": {} },
                ".profile-field": {
                    "@apply flex flex-row items-center justify-between mb-4 rounded-2xl bg-white dark:bg-[#0D1B2D] px-4 py-3 border border-gray-100 dark:border-[#29405C]": {},
                },
                ".profile-field__icon": {
                    "@apply size-12 rounded-2xl bg-primary/10 flex items-center justify-center mr-3": {},
                },
                ".searchbar": {
                    "@apply relative flex flex-row items-center justify-start w-full bg-white dark:bg-[#0D1B2D] shadow-lg shadow-black/5 rounded-full font-ezra-medium text-dark-100 dark:text-slate-50 gap-4 px-5": {},
                },
                ...
                ".restaurant-card": { "@apply flex flex-row gap-4 bg-white dark:bg-[#0D1B2D] p-4 rounded-3xl border border-gray-100 dark:border-[#29405C] shadow-lg shadow-black/5": {} },
                ".rating-pill": { "@apply flex flex-row items-center rounded-full bg-white/90 dark:bg-[#13243A] px-3 py-1 border border-gray-100 dark:border-[#29405C]": {} },
                ".info-chip": { "@apply flex flex-row items-center gap-1 px-3 py-1 rounded-full bg-gray-50 dark:bg-[#172A42] border border-gray-100 dark:border-[#29405C]": {} },
                ...
                ".paragraph-medium": { "@apply text-base font-ezra-medium text-dark-60 dark:text-slate-300": {} },
                ".body-medium": { "@apply text-sm font-ezra-medium text-dark-60 dark:text-slate-300": {} },
                ...
                ".chip": { "@apply px-4 py-2 rounded-full bg-white dark:bg-[#0D1B2D] border border-gray-100 dark:border-[#29405C] flex-row items-center gap-2": {} },
                ".section-title": { "@apply text-lg font-ezra-bold text-dark-100 dark:text-slate-50": {} },
                ".secondary-card": { "@apply rounded-3xl p-4 bg-white dark:bg-[#0D1B2D] shadow-lg shadow-black/5 border border-gray-100 dark:border-[#29405C]": {} },
            });
        }),
    ],
};
