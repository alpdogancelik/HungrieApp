...
import lifestyleTwoImage from "@/assets/images/2.jpeg";
import lifestyleThreeImage from "@/assets/images/3.jpeg";
...
const avocado = tacoImage;
const bacon = burgerImage;
const burgerOne = burgerImage;
const burgerTwo = burgerDeliveryImage;
const buritto = tacoImage;
const cheese = pizzaImage;
const coleslaw = foodDeliveryMessageImage;
const cucumber = foodOrderImage;
const emptyState = emptyStateImage;
const fries = friesImage;
...
const onions = lifestyleTwoImage;
const pizzaOne = pizzaImage;
const salad = lifestyleThreeImage;
const success = successImage;
const tomatoes = orderBillImage;

const burgerPoster = burgerImage;
const pizzaPoster = pizzaImage;
const friesPoster = friesImage;
const tacoPoster = tacoImage;
