...
const CATEGORY_TITLES: Record<string, string> = {
    ...
    pizza: "Pizzalar",
    pizzas: "Pizzalar",
    grill: "Izgara Çeşitleri",
    chicken: "Tavuk Yemekleri",
    pasta: "Makarnalar",
    salads: "Salatalar",
    snacks: "Atıştırmalıklar",
    crispy: "Çıtır Lezzetler",
    drinks: "İçecekler",
    drinks_cold: "Soğuk İçecekler",
    drinks_hot: "Sıcak İçecekler",
    toast: "Tost / Sandviç",
    gozleme: "Gözlemeler",
    soups: "Aperatifler",
    sides: "Ekstralar",
                ...
                <View style={styles.hero}>
                    ...
                    <View style={styles.heroInner}>
                        ...
                        <View style={styles.heroMeta}>
                            <Text style={styles.heroBadge}>Alacarte Cafe • Fast Food & Grill
                                (+90 539 100 66 68)
                            </Text>
                            <Text style={styles.heroTitle}>{restaurant.name || "Alacarte Cafe"}</Text>
                            <Text style={styles.heroSubtitle}>Fast food · Izgara · Makarna · Salata</Text>
