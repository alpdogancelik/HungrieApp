...
const normalizeStatus = (status?: string) => {
    ...
    if (["pending", "preparing", "ready", "out_for_delivery", "delivered", "canceled"].includes(status)) return status;
    return "pending";
};
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    const label = ORDER_STATUS_LABELS[normStatus] || t(`status.${normStatus}` as any);
                        ...
                        >
                            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                ...
                                >
                                    ...
                                    <Text style={{ color: badge.text, fontFamily: "ChairoSans", marginLeft: 6 }}>{label}</Text>
                                </View>
                            </View>
                            ...
                            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 12 }}>
                                <View>
                                    <Text style={{ color: "#94A3B8", fontFamily: "ChairoSans" }}>{t("cart.screen.summary.total")}</Text>
