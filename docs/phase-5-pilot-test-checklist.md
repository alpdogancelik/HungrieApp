...
| REC-06 | Suspend the Restaurant entity while an order is open. | Restaurant staff cannot mutate it, new checkout is denied, and Admin support handling remains available. Restore the test Restaurant afterward. | Pass (pilot report and Restaurant restoration verified, 2026-09-14) |
